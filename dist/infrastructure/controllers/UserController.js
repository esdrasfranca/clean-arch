...
export class UserController {
    ...
    async create(req, res) {
        ...
        const userDto = new CreateUserDTO(req.body.name, req.body.email, req.body.password);
    ...
    async update(req, res) {
        ...
        const userDto = new UpdateUserDTO(req.body.name, req.body.email, req.body.password);
